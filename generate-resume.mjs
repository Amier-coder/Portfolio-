...
async function createResume() {
  ...
  page.drawText('Ameer Hamza', { x: 60, y: height - 70, size: 28, font: fontBold, color: rgb(1, 1, 1) });
  page.drawText('Full-Stack Web Developer', { x: 60, y: height - 100, size: 14, font, color: rgb(0.7, 0.8, 1) });
  ...
  const sections = [
    {
      ...
      body: 'Full-Stack Web Developer with expertise in React, TypeScript, Node.js, and modern web technologies. Passionate about building scalable, performant, and user-centric web applications. Experienced in e-commerce platforms, ERP systems, POS solutions, and custom media players. Strong focus on clean architecture, responsive design, and developer experience.'
    },
    {
  ...
  page.drawText('— Generated for portfolio —', { x: 60, y: 40, size: 9, font, color: rgb(0.5, 0.5, 0.6) });
